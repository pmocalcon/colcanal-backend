...
export class CreateUserDto {
  ...
  @Matches(/@(canalcongroup\.com|canalco\.com|alumbrado\.com)$/, {
    message:
      "El correo debe ser del dominio corporativo (@canalcongroup.com, @canalco.com, @alumbrado.com)",
  })
  email: string;

  @ApiPropertyOptional({
    description:
      "Correo electrónico para recibir notificaciones (dominio @alumbrados.co)",
