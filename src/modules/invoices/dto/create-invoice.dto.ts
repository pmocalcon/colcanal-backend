...
export class CreateInvoiceDto {
  ...
  @ApiPropertyOptional({
    description:
      "Monto de la factura. Si no se especifica, se usa el total de la orden de compra",
    example: 5000000.0,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description:
      "Cantidad de material. Si no se especifica, se usa la cantidad total de la orden de compra",
    example: 100,
  })
  @IsOptional()
