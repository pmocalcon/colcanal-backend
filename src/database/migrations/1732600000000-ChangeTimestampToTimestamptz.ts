...
export class ChangeTimestampToTimestamptz1732600000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(
      "✅ Migración completada: Todas las columnas timestamp ahora son timestamptz",
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(
      "⏪ Migración revertida: Las columnas volvieron a ser timestamp",
    );
  }
}
