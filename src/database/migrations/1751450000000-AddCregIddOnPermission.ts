...
/**
 * Nuevo sub-modulo CREG: ID ON (indice de disponibilidad de las encendidas).
 *
 * Mismo alcance que el resto de CREG: 6 Director Tecnico, 11 Director de
 * Proyecto Putumayo y 12 Analista PMO.
 */
export class AddCregIddOnPermission1751450000000 implements MigrationInterface {
  name = 'AddCregIddOnPermission1751450000000';

  private static readonly PERMISO = 'creg:iddon';
  private static readonly DESCRIPCION =
    'Acceder al indice de disponibilidad de las encendidas (ID ON)';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      ...
      [
        AddCregIddOnPermission1751450000000.PERMISO,
        AddCregIddOnPermission1751450000000.DESCRIPCION,
      ],
    );

    for (const rolId of AddCregIddOnPermission1751450000000.ROLES) {
      await queryRunner.query(
        ...
        [rolId, AddCregIddOnPermission1751450000000.PERMISO],
      );
    }
  }
