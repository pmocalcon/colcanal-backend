    ...
    const requisitionStatusesData = [
      {
        ...
        description: 'Requisición con obra pendiente de validación por Director de Proyecto',
        color: 'indigo',
        order: 1,
      },
      {
      ...
      },
      {
        ...
        description: 'Devuelta al solicitante por Director de Proyecto en validación de obra',
        color: 'pink',
        order: 9,
      },
      {
